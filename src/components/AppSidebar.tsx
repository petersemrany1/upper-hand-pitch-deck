import { DollarSign, Gamepad2, Presentation, LayoutDashboard, Phone, Building2, LogOut, Settings as SettingsIcon, Send, Users, Headphones, Trophy, ChevronDown, Calendar, BarChart3, GraduationCap, BookOpen, UserSearch, PhoneCall, Brain, Monitor, Bell, FileAudio } from "lucide-react";
...
const ALL_FOLDERS: NavFolder[] = [
  {
    ...
    items: [
      ...
      { title: "Numbers", url: "/numbers", icon: DollarSign, tab: "numbers" },
      { title: "Numbers Game", url: "/numbers-game", icon: Gamepad2, tab: "numbers_game" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Clinic Meta Leads", url: "/sales-test-leads", icon: UserSearch, tab: "sales_test_leads" },
    ],
  },
