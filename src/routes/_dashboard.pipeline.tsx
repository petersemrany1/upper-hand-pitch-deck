...
import { Users, Clock, CheckCircle2, PhoneOff, XCircle, Filter, ChevronDown, ChevronUp } from "lucide-react";
...
function PipelinePage() {
  ...
  const stats = [
    { label: "Total Screened", value: totalScreened.toLocaleString(), icon: Filter, color: "#2D6BE4" },
