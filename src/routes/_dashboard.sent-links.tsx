                    ...
                    {confirmDeleteId === r.id ? (
                      <>
                        <button
                          ...
                          disabled={busy}
                          className="inline-flex items-center gap-1 text-xs font-semibold px-3 py-2 rounded-lg bg-red-500 text-foreground hover:bg-red-600 disabled:opacity-40 transition-colors"
                        >
