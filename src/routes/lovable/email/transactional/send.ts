...
const SENDER_DOMAIN = "notify.hairtransplantgroup.com.au"
// FROM_DOMAIN is the domain shown in the From: header (e.g., "example.com").
// Can be the root domain when display_from_root is enabled — this is cosmetic only.
const FROM_DOMAIN = "notify.hairtransplantgroup.com.au"
  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        // Verify caller. Accepts either a valid Supabase user JWT, or the
        // service role key for trusted server-to-server callers (e.g. our own
        // /api/public/* webhooks running in the same app).
